...
class PasporController extends Controller
{
    ...
    public function cetak(Request $request)
    {
        ...
        $tujuan     = strtoupper($request->tujuan ?? 'WISATA'); // FIX: Definisi Tujuan
        ...
        // ==========================================
        $data = [
            // --- DATA TEKS (PENTING UNTUK HALAMAN 3 & 4) ---
            'tujuan'        => $tujuan, // <-- INI YANG TADI ERROR (Sekarang sudah ada)
            'nama'          => $nama,
