...
<html>
<head>
    <title>Berkas Paspor Lengkap Final</title>
    <style>
        /* --- GLOBAL --- */
        @page { margin: 0px; }
...
<body>
    ...
    <div class="box-perhatian"><div style="font-weight:bold; text-align:center; margin-bottom:2px;">PERHATIAN</div><ol class="list-perhatian"><li>Isi formulir dengan HURUF CETAK...</li><li>Tanda asterisk berarti...</li><li>Lampirkan dokumen...</li><li>Pemohon Wajib...</li><li>Formulir ini tidak...</li><li>Jika dalam pengisian...</li><li>Cara pengisian tanggal... CONTOH : &nbsp; <span class="k-ex">2</span><span class="k-ex">6</span> <span class="k-ex">0</span><span class="k-ex">1</span> <span class="k-ex">0</span><span class="k-ex">8</span></li></ol></div>
                ...
                <table style="width:100%; border-collapse:collapse;">
                    <tr>
                        <td width="70%" style="border-right: 1px solid #000; padding: 4px; vertical-align:top;">
                            ...
                            <div>C. PERUBAHAN * &nbsp;&nbsp; <span class="chk"></span> 1. Nama &nbsp;&nbsp; 2. Alamat &nbsp;&nbsp; 3. Lain-lain</div>
                        </td>
                        <td width="30%" style="vertical-align:top; padding: 4px;">
                            ...
                            <div style="text-align:center;">@for($i=0;$i<8;$i++)<div class="k">&nbsp;</div>@endfor</div>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <div class="surat-container">
        ...
        <div class="legal-block">
            ...
            <ol type="a" start="3" style="margin-top:0; padding-left:15px; margin-bottom:3px;">
                <li>memberikan data yang tidak sah atau keterangan yang tidak benar untuk memperoleh Dokumen Perjalanan Republik Indonesia...</li>
                <li>Memiliki atau menggunakan secara melawan hukum 2 (dua) atau lebih Dokumen Perjalanan Republik Indonesia...</li>
            </ol>
        ...
        <ol class="point-list">
            ...
            <li>Semua surat atau dokumen yang saya lampirkan dalam pengajuan permohonan Paspor RI ini adalah benar milik saya dan sah secara hukum...</li>
            ...
            <li>Apabila permohonan saya Ditolak Sistem/ Ditolak Wawancara/ Ditolak Adjudikator/ Reject Adjudicator Pusat...</li>
            <li>Bahwa saya tidak akan menyerahkan paspor tersebut yang masih berlaku kepada orang lain yang tidak berhak;</li>
            <li>Apabila paspor tersebut tidak saya ambil sampai batas waktu 30 (tiga puluh) hari sejak tanggal diterbitkan, maka saya mengetahui...</li>
