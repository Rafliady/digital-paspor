...
<html>
<head>
    <title>Berkas Paspor Kanim Kelas II Non TPI Wonosobo</title>
    <style>
        /* --- GLOBAL --- */
        @page { margin: 0px; }
        body { font-family: 'Arial MT', Arial, sans-serif; font-size: 9px; margin: 15px 30px; }
        ...
        /* --- STYLES SURAT (FONT 11) --- */
        .surat-container { font-size: 11pt; line-height: 1.15; }
        ...
        .judul-surat { text-align: center; font-weight: bold; font-size: 11pt; margin: 20px 0; text-transform: uppercase; }
        .table-isian { width: 100%; font-size: 11pt; border-collapse: collapse; margin-bottom: 5px; }
        .table-isian td { padding: 4px 0; vertical-align: top; }
        .dots-fill { border-bottom: 1px dotted #000; }
        .point-list { padding-left: 20px; font-size: 11pt; line-height: 1.3; text-align: justify; }
        .point-list li { margin-bottom: 5px; }
...
<body>
    ...
    <table class="header-table"><tr><td width="5%"><div class="square-mark"></div></td><td width="55%"><div class="instansi">KEMENTERIAN IMIGRASI DAN PEMASYARAKATAN RI<br>KANWIL DITJEN IMIGRASI JATENG<br>KANTOR IMIGRASI KELAS II NON TPI WONOSOBO</div></td><td width="35%"><div class="perdim-info">PERDIM : 11<br>NO : ....................</div></td><td width="5%" align="right"><div class="square-mark"></div></td></tr></table>
    ...
    <div class="box-perhatian"><div style="font-weight:bold; text-align:center; margin-bottom:2px;">PERHATIAN</div><ol class="list-perhatian"><li>Isi formulir dengan HURUF CETAK dan TINTA HITAM</li><li>Tanda asterisk berarti (*) Diisi sesuai nomor pilihan, (**) Lengkapi dengan nama/ alias bila ada, (***) Bagi mahasiswa/ pelajar, alamat kantor/ pekerjaan diisi dengan nama perguruan tinggi/ sekolah</li><li>Lampirkan dokumen identitas diri dan dokumen lain yang merupakan persyaratan</li><li>Pemohon Wajib datang untuk verifikasi, pengambilan sidik jari dan foto</li><li>Formulir ini tidak  dikenakan biaya apapun</li><li>Jika dalam pengisian formulir ini kurang jelas, hubungi petugas pelayanan keimigrasian</li><li>Cara pengisian tanggal adalah dengan urutan tanggal - bulan - tahun</li></ol></div>
                ...
                <table style="width:100%; border-collapse:collapse;">
                    <tr>
                        <td width="70%" style="border-right: 1px solid #000; padding: 4px; vertical-align:top;">
                            <div class="f-label">PERMOHONAN *</div>
                            <div style="margin-bottom:2px;">A. BARU * &nbsp;&nbsp; <span class="chk"></span> 1. Paspor Biasa Non Elektronik &nbsp;&nbsp; <span class="chk"></span> 2. Elektronik</div>
                            <div style="margin-bottom:2px;">
                                B. PENGGANTIAN * &nbsp; 
                                <span class="chk"></span> 1. Habis Berlaku &nbsp; 
                                <span class="chk"></span> 2. Halaman Penuh &nbsp; 
                                <span class="chk"></span> 3. Hilang &nbsp;
                                <span class="chk"></span> 4. Rusak &nbsp;
                                <span class="chk"></span> 5. E-Paspor
                            </div>
                            <div>C. PERUBAHAN * &nbsp;&nbsp; <span class="chk"></span> 1. Nama &nbsp;&nbsp; <span class="chk"></span> 2. Alamat &nbsp;&nbsp; <span class="chk"></span> 3. Lain-lain</div>
                        </td>
                        <td width="30%" style="vertical-align:top; padding: 4px;">
                            <div style="text-align:center; font-weight:bold; font-size:8px; margin-bottom:5px;">TGL PERMOHONAN</div>
                            <div style="text-align:center;">@foreach($tgl_permohonan_chars as $c)<div class="k">{{ $c }}</div>@endforeach</div>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table class="main-layout" style="margin-top: 20px;">
        ...
        <tr><td class="col-num">4</td><td style="padding:5px; border-bottom: 1px solid #000;"><div style="text-align:justify; font-size:8px; line-height:1.2; margin-bottom:10px;">Seluruh keterangan dan data yang saya nyatakan dalam formulir ini adalah sah dan sesuai dengan keadaannya yang sebenarnya, dan apabila kemudian hari ternyata pernyataan ini tidak benar, saya bersedia dituntut sesuai ketentuan peraturan perundang undangan yang berlaku.</div><table style="width:100%; font-size:8px; border-collapse:collapse;"><tr><td width="35%" valign="bottom">Tanda tangan yang diberi kuasa,<br><br><br><br></td><td width="30%"></td><td width="35%" align="right" valign="bottom">Tanda tangan pemohon,<br><br><br><br></td></tr><tr><td valign="middle" style="padding: 2px 0;"><table style="width:auto;"><tr><td style="padding-right:5px;">Nama</td><td>@foreach($nama_ambil_1_chars as $c)<div class="k">{{ $c }}</div>@endforeach</td></tr></table></td><td></td><td align="right" valign="bottom"><span class="dotted-line" style="width:150px;"></span></td></tr><tr><td colspan="3" style="padding: 10px 0;">Paspor diterima pada tanggal : &nbsp; @for($i=0;$i<8;$i++)<div class="k">&nbsp;</div>@endfor</td></tr><tr><td valign="bottom">Tanda tangan penerima,<br><br><br><br></td><td></td><td align="right" valign="bottom">Petugas yang menyerahkan,<br><br><br><br></td></tr><tr><td valign="middle" style="padding: 2px 0;"><table style="width:auto;"><tr><td style="padding-right:5px;">Nama</td><td>@foreach($nama_ambil_2_chars as $c)<div class="k">{{ $c }}</div>@endforeach</td></tr></table></td><td></td><td align="right" valign="bottom"><span class="dotted-line" style="width:150px;"></span></td></tr></table></td></tr>
        <tr><td class="col-num">5</td><td style="padding:0; border-bottom: 1px solid #000;"><table style="width:100%; border-collapse:collapse;"><tr><td width="50%" style="border-right:1px solid #000; padding:4px; vertical-align:top;"><div class="f-label bold">CATATAN PETUGAS LOKET</div><div style="font-size:8px;">Lampiran persyaratan :</div><ul class="list-syarat"><li><span class="chk-box"></span> Copy KTP WNI</li><li><span class="chk-box"></span> Copy Kartu Keluarga</li><li><span class="chk-box"></span> Copy Akte Kelahiran/ Surat Nikah/ Ijazah</li><li><span class="chk-box"></span> Paspor /SPLP Lama</li><li><span class="chk-box"></span> Surat Keterangan Hilang dari Kepolisian</li><li><span class="chk-box"></span> Surat Rekomendasi/ Izin Atasan/ Sponsor</li><li><span class="chk-box"></span> Surat Kuasa/ Kartu Tanda pengenalan Kepengurusan Imigrasi</li></ul><div style="text-align:right; margin-top:20px; padding-right:10px;"><div style="margin-bottom:25px; font-size:8px;">Paraf Petugas</div><span class="dotted-line" style="width:80px;"></span></div></td><td width="50%" style="padding:4px; vertical-align:top;"><div class="f-label bold">CATATAN PETUGAS WAWANCARA</div><div style="font-size:8px; margin-bottom:15px; margin-top:5px;">1. <span class="dotted-line" style="width:90%;"></span></div><div style="font-size:8px; margin-bottom:15px;">2. <span class="dotted-line" style="width:90%;"></span></div><div style="font-size:8px; margin-bottom:30px;">3. <span class="dotted-line" style="width:90%;"></span></div><div style="text-align:right; margin-top:10px; padding-right:10px;"><div style="margin-bottom:25px; font-size:8px;">Paraf Pejim,</div><span class="dotted-line" style="width:80px;"></span></div></td></tr></table></td></tr>
    ...
    <div class="surat-container">
        ...
        <div class="judul-surat" style="margin-top: 50px; text-decoration:none; font-weight:bold;">SURAT PERNYATAAN</div>
        
        <div style="font-size:11pt; margin-top:20px;">Saya yang bertandatangan di bawah ini :</div>
        <table class="table-isian">
            <tr><td width="150">Nama</td><td width="10">:</td><td class="dots-fill bold">{{ $ayah_nama }}</td></tr>
            <tr><td>Tempat/Tanggal Lahir</td><td>:</td><td class="dots-fill bold">{{ $ayah_ttl }}</td></tr>
            <tr><td>Alamat</td><td>:</td><td class="dots-fill bold">{{ $ortu_alamat }}</td></tr>
        </table>

        <div style="font-size:11pt; margin-top:15px;">Dengan ini saya selaku Orang Tua (Ayah / Ibu) dari :</div>
        <table class="table-isian">
            <tr><td width="150">Nama</td><td width="10">:</td><td class="dots-fill bold">{{ $nama }}</td></tr>
            <tr><td>Jenis Kelamin</td><td>:</td><td class="dots-fill bold">{{ $jk_long }}</td></tr>
            <tr><td>Tempat/Tanggal Lahir</td><td>:</td><td class="dots-fill bold">{{ $ttl }}</td></tr>
            <tr><td>Alamat</td><td>:</td><td class="dots-fill bold">{{ $alamat }}</td></tr>
        </table>

        <div style="font-size:11pt; margin-top:15px;">Menyatakan bahwa terhadap anak saya tersebut diatas :</div>
        <ol class="point-list" style="margin-top:5px;">
            <li>Belum pernah memiliki Paspor;</li>
            <li>Saya tidak keberatan kepada yang bersangkutan diberikan Paspor dan keberadaan Paspor tersebut menjadi tanggungjawab saya sepenuhnya;</li>
            <li>Anak saya akan berangkat ke Luar Negeri bersama :
                <table width="100%" style="margin-top:5px;">
                    <tr><td width="130">Nama</td><td>: ..........................................................................................</td></tr>
                    <tr><td>Tempat/Tanggal Lahir</td><td>: ..........................................................................................</td></tr>
                    <tr><td>Paspor Nomor</td><td>: ..........................................................................................</td></tr>
                    <tr><td>Alamat</td><td>: ..........................................................................................</td></tr>
                </table>
            </li>
            <li>Tujuan keberangkatan : <span class="dots-fill bold">{{ $tujuan ?? 'WISATA' }}</span></li>
            <li>Saya bertanggungjawab terhadap keberangkatan dan kembalinya anak saya ke Indonesia.</li>
        </ol>

        <div style="font-size:11pt; text-align:justify; margin-top:15px; line-height:1.5;">
            Demikian Surat Pernyataan ini saya buat dengan sebenarnya dan apabila keterangan diatas tidak sesuai dengan kenyataan, saya bersedia dituntut sesuai peraturan yang berlaku.
        </div>
